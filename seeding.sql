...
INSERT INTO customers (id, customer_id, name, phone, email, address, city, state, country, zip)
VALUES (1, 10001, 'Pablo Picasso', '+34 636 1763 82', '', 'Paseo de la Chopera, 14', 'Madrid', 'Madrid', 'Spain', '29045'),
       (2, 20001, 'Abraham Lincoln', '+1 305 907 7086', '', '120 SW 8th St', 'Miami', 'Florida', 'United States', '33130'),
       (3, 30001, 'Napoleon Boneparte', '+33 179 7540 00', '', '40 Rue du Colisée', 'Paris', 'Île-de-France', 'France', '75008');
...
INSERT INTO invoices (id, invoice_nr, date, car, customer, salesperson)
